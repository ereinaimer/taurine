...
pub use gate::{
    INJECTION_GENERATION, IS_INJECTING, IS_SIMULATING, InjectionFlagGuard,
    InjectionVisibilityGuard, abort_injection, capture_generation, init_injection_pool, is_aborted,
    spawn_guarded_injection_thread,
};
