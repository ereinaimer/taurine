...
| `parakeet-tdt-ctc-110m` | Hybrid FastConformer TDT-CTC INT8 (`sherpa-onnx`) | `https://github.com/k2-fsa/sherpa-onnx/releases/download/asr-models/sherpa-onnx-nemo-parakeet_tdt_ctc_110m-en-36000-int8.tar.bz2` | `.tar.bz2` | ~135 MB | Verified on download | CC-BY-4.0 | Light and fast English dictation for constrained machines |
