...
```bash
sudo apt update
sudo apt install build-essential protobuf-compiler libxkbcommon-dev libdbus-1-dev pkg-config libasound2-dev libappindicator-gtk3 libglib2.0-dev libgtk-3-dev -y
```
