...
- **Linux Service Restart Reload**: Automatically reload systemd user unit definitions before starting or restarting the service to prevent failures when unit files change on disk.
